...
export class Backend implements backendInterface {
    ...
    async registerPhone(arg0: string): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.registerPhone(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async setTopic(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setTopic(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
