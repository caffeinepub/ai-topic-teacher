...
function ComprehensionQuiz({
  ...
  if (showResult && resultData) {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-white flex items-center justify-center p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md w-full text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-6xl mb-4", children: passed ? score >= 80 ? "🎉" : "👍" : "💪" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl font-bold text-gray-800 mb-2", children: "Quiz Complete!" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-5xl font-bold text-blue-600 mb-2", children: [
        score,
        "%"
      ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center mb-6", children: passed ? /* @__PURE__ */ jsxRuntimeExports.jsx(
        "span",
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          className: `rounded-2xl p-4 mb-6 ${passed ? score >= 80 ? "bg-green-50 border border-green-200" : "bg-yellow-50 border border-yellow-200" : "bg-rose-50 border border-rose-200"}`,
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              className: `font-semibold ${passed ? score >= 80 ? "text-green-700" : "text-yellow-700" : "text-rose-700"}`,
              children: passed ? score >= 80 ? "🌟 Amazing! You're moving up a level!" : "📚 Good effort! Keep practicing at this level." : "🔄 Don't give up! Try the same passage again."
            }
          )
        }
      ),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-white", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-blue-600 text-white px-4 pt-10 pb-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-xl font-bold", children: "Comprehension Quiz" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Progress, { value: progress, className: "h-2 bg-white/30" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-amber-50 rounded-2xl p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-800 text-lg font-semibold leading-relaxed", children: q.question }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: q.options.map((opt, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          type: "button",
          "data-ocid": `quiz.option.${i + 1}`,
          onClick: () => setSelected(i),
          className: `w-full p-4 rounded-xl text-left text-base font-medium border-2 transition-all ${selected === i ? "border-blue-500 bg-blue-50 text-blue-800" : "border-gray-200 bg-white text-gray-700 hover:border-gray-300"}`,
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "mr-3 font-bold text-gray-400", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Button,
        {
          ...
          onClick: handleNext,
          className: "w-full h-12 rounded-xl bg-blue-600 hover:bg-blue-700 text-white text-lg",
          children: current + 1 === total ? "Submit Answers" : "Next Question →"
        }
      )
    ] })
  ] }) });
...
function Dashboard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-amber-50", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md mx-auto", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl font-bold", children: student.name })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white/20 rounded-2xl px-4 py-2 text-right", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/80 text-xs", children: "Current Level" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-white/20 rounded-full h-2 mt-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md mx-auto px-4 py-6 space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-3xl", children: recordFeature.icon }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: `font-bold ${gradeTextColors[student.grade]}`, children: recordFeature.title }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 text-sm", children: recordFeature.desc })
            ] })
          ]
        }
      ),
      student.badges.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-2xl p-4 border border-amber-100", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-gray-700 mb-2", children: "🏅 Your Badges" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: student.badges.map((b) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
          {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Button,
        {
          ...
          children: "📊 View My Progress Report"
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Button,
...
function IntonationPractice({
  ...
  const mediaRecorder = reactExports.useRef(null);
  ...
  const stopRecording = () => {
    var _a2;
    (_a2 = mediaRecorder.current) == null ? void 0 : _a2.stop();
    setRecording(false);
  };
  const renderSentence = (text, stressed) => {
    const words = text.split(" ");
    return words.map((word, wordIdx) => {
      const clean2 = word.replace(/[^a-zA-Z]/g, "");
      const isStressed = stressed.some(
        (sw) => word.toUpperCase().includes(sw.toUpperCase()) || sw === clean2
      );
      return /* @__PURE__ */ jsxRuntimeExports.jsx(
        "span",
        {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-white", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-green-600 text-white px-4 pt-10 pb-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl font-bold", children: "🎵 Intonation Practice" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 space-y-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-green-50 rounded-2xl p-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3 mb-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-3xl", children: s.type === "rising" ? "↗️" : s.type === "falling" ? "↘️" : "💥" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold text-green-600 uppercase tracking-wide mb-1", children: s.type === "rising" ? "Rising Intonation" : s.type === "falling" ? "Falling Intonation" : "Emphasis" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xl leading-relaxed", children: renderSentence(s.text, s.stressedWords) })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-white rounded-xl p-3 border border-green-200", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-green-700 text-sm", children: [
          "💡 ",
          s.tip
        ] }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3 items-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-2xl", children: recording ? "⏹" : "🎙️" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm mt-1", children: recording ? "Stop" : "Record" })
            ]
          }
        ),
        recordings[current] && // biome-ignore lint/a11y/useMediaCaption: self-recorded audio, no captions needed
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "audio",
          {
            controls: true,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3", children: [
        ...
        current + 1 < sentences.length ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          Button,
          {
            type: "button",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: sentences.map((sent, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          type: "button",
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mr-2", children: sent.type === "rising" ? "↗️" : sent.type === "falling" ? "↘️" : "💥" }),
            sent.text,
            recordings[i] && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-2 text-green-500", children: "✓" })
          ]
        },
        sent.text
      )) })
...
function MissingWords({ passage, onComplete, onBack }) {
  const { missingWords } = passage;
  const [filled, setFilled] = reactExports.useState(
    Array(missingWords.answers.length).fill(null)
  );
  const [usedWords, setUsedWords] = reactExports.useState(/* @__PURE__ */ new Set());
  const [submitted, setSubmitted] = reactExports.useState(false);
  const handleWordSelect = (word) => {
    if (usedWords.has(word)) {
      const idx2 = filled.indexOf(word);
      if (idx2 !== -1) {
    ...
    if (idx !== -1) {
      ...
      newFilled[idx] = word;
      setFilled(newFilled);
      setUsedWords((prev) => /* @__PURE__ */ new Set([...prev, word]));
    }
  };
  const clearSlot = (i) => {
    const word = filled[i];
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          parts[1],
          submitted && isWrong && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "ml-2 text-sm text-green-600 font-semibold", children: [
            "(✓ ",
  ...
  if (submitted) {
    ...
    const score = Math.round(correct / missingWords.answers.length * 100);
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-white p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md mx-auto pt-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-5xl mb-3", children: score >= 80 ? "⭐" : score >= 50 ? "👏" : "💪" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display text-2xl font-bold text-gray-800", children: [
          score,
          "% Correct!"
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3 mb-6", children: missingWords.sentences.map((s, i) => renderSentence(s, i)) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Button,
        {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-white", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-yellow-500 text-white px-4 pt-10 pb-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl font-bold", children: "✏️ Missing Words" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/80 text-sm mt-1", children: "Tap a word from the bank to fill in the blanks" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: missingWords.sentences.map((s, i) => renderSentence(s, i)) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-gray-50 rounded-2xl p-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 text-sm font-semibold mb-3", children: "Word Bank:" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: missingWords.wordBank.map((word) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
...
function Onboarding({ onComplete }) {
  ...
  const [grade, setGrade] = reactExports.useState(0);
  const gradeColors2 = [
    "bg-emerald-500",
    "bg-blue-500",
    "bg-purple-500",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-amber-50 flex items-center justify-center p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-md", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-6xl mb-4", children: "📚" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-4xl font-bold text-amber-900 mb-2", children: "ReadWise" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-amber-700 text-lg", children: "Adaptive Reading for Every Learner" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-3xl shadow-lg p-8 space-y-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "block text-sm font-semibold text-gray-700 mb-2", children: "What's your name?" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
            id: "student-name",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "block text-sm font-semibold text-gray-700 mb-3", children: "Pick your grade" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-5 gap-2", children: gradeColors2.map((color, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            type: "button",
            ...
            children: [
              i + 1,
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-normal mt-0.5", children: "Grade" })
            ]
          },
          color
        )) })
...
function PassageReader({ passage, onStartQuiz, onBack }) {
  const [activeChunk, setActiveChunk] = reactExports.useState(null);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-white", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-blue-600 text-white px-4 pt-10 pb-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl font-bold", children: passage.title }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-white/70 text-sm mt-1", children: [
        "Grade ",
        passage.grade,
        " Reading"
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 space-y-6", children: [
      mode === "full" ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-amber-50 rounded-2xl p-5", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-800 text-lg leading-relaxed font-body", children: passage.text }) }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 text-sm mb-3", children: "Tap each chunk to highlight it as you read:" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-amber-50 rounded-2xl p-5 leading-loose", children: passage.chunks.map((chunk, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-400 text-xs mt-2", children: "Tap each phrase group to follow along" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Button,
        {
          ...
          children: "Start Comprehension Quiz →"
        }
      )
    ] })
  ] }) });
...
function ProgressReport({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-white", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-amber-500 text-white px-4 pt-10 pb-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl font-bold", children: "📊 Progress Report" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-white/70 text-sm mt-1", children: [
        student.name,
        "'s Learning Journey"
      ] })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 space-y-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-3 gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-blue-50 rounded-2xl p-3 text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-3xl font-bold text-blue-600", children: student.grade }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 text-xs mt-1", children: "Current Grade" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-green-50 rounded-2xl p-3 text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-3xl font-bold text-green-600", children: student.sessions.length }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 text-xs mt-1", children: "Activities" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-purple-50 rounded-2xl p-3 text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-3xl font-bold text-purple-600", children: [
            averageScore,
            "%"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 text-xs mt-1", children: "Avg Score" })
        ] })
      ] }),
      onNavigate && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-gray-50 rounded-2xl p-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-gray-700 mb-3", children: "🎯 Practice Activities" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-2", children: practiceActivities.map((a, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            type: "button",
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xl", children: a.icon }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: `font-semibold text-xs ${a.textColor}`, children: a.title })
            ]
          },
          a.id
        )) })
      ] }),
      gradeHistory.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-gray-50 rounded-2xl p-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-gray-700 mb-3", children: "Grade Level Progress" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-end gap-2 h-24", children: quizSessions.map((qs) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: "flex-1 flex flex-col items-center gap-1",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-gray-400", children: qs.grade }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-400 mt-2", children: "Quiz sessions" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-amber-50 rounded-2xl p-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-gray-700 mb-3", children: "🏅 Badges" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: allBadges.map((b) => {
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-2xl", children: b.emoji }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "p",
                    {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-400", children: b.desc })
                ] }),
                earned && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-auto text-green-500 text-lg", children: "✓" })
              ]
            },
            b.name
          );
      ...
      student.sessions.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-gray-50 rounded-2xl p-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-gray-700 mb-3", children: "Recent Activity" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: student.sessions.slice(-5).reverse().map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: "flex items-center justify-between text-sm",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: activityLabels[s.activity] || s.activity }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-500", children: s.activity === "quiz" ? `${s.score}%` : "✓" })
            ]
          },
          s.id
        )) })
...
function PronunciationPractice({
  ...
  const [current, setCurrent] = reactExports.useState(0);
  const [practiced, setPracticed] = reactExports.useState(/* @__PURE__ */ new Set());
  const w = words[current];
  const allDone = practiced.size === words.length;
  const markPracticed = () => {
    setPracticed((prev) => /* @__PURE__ */ new Set([...prev, current]));
    if (current + 1 < words.length) setCurrent((c) => c + 1);
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-white", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-purple-600 text-white px-4 pt-10 pb-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl font-bold", children: "🗣️ Pronunciation" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-white/70 text-sm mt-1", children: [
        "Word ",
        current + 1,
        " of ",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-1 mt-3", children: words.map((wd, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 space-y-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-purple-50 rounded-3xl p-6 text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-5xl font-bold text-purple-900 font-display mb-2", children: w.word }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-2xl text-purple-600 font-semibold tracking-widest", children: w.syllables }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-purple-400 mt-1 text-lg", children: w.phonetic })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-amber-50 rounded-2xl p-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 text-xs font-semibold uppercase tracking-wide mb-1", children: "Example Sentence" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-gray-800 text-base leading-relaxed italic", children: [
          "“",
          w.example,
          "”"
        ] })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Button,
          {
            ...
            children: practiced.has(current) ? "✓ Practiced" : "I Can Say It!"
          }
        )
      ] }),
      allDone && /* @__PURE__ */ jsxRuntimeExports.jsx(
        Button,
        {
          ...
          children: "🎉 All Done! Back to Home"
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: words.map((w2, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
...
function analyzeTranscript(passage, transcript) {
  const passageWords = passage.trim().split(/\s+/);
  const heardWords = transcript.trim().split(/\s+/).map(normalize).filter(Boolean);
  const results = [];
  let hi = 0;
  for (let pi = 0; pi < passageWords.length; pi++) {
    ...
    if (heardWords[hi] === expected) {
      ...
      if (!foundAhead) {
        const nextExpected = passageWords[pi + 1] ? normalize(passageWords[pi + 1]) : "";
...
function ReadAndRecord({ passage, onComplete, onBack }) {
  const [recording, setRecording] = reactExports.useState(false);
  ...
  const [rating, setRating] = reactExports.useState(null);
  const [saved, setSaved] = reactExports.useState(false);
  const [error, setError] = reactExports.useState("");
  const [speechSupported, setSpeechSupported] = reactExports.useState(true);
  const mediaRecorder = reactExports.useRef(null);
  const chunks = reactExports.useRef([]);
  const recognition = reactExports.useRef(null);
  const liveTranscript = reactExports.useRef("");
  reactExports.useEffect(() => {
  ...
  const stopRecording = () => {
    var _a2, _b2;
    (_a2 = recognition.current) == null ? void 0 : _a2.stop();
    (_b2 = mediaRecorder.current) == null ? void 0 : _b2.stop();
    setRecording(false);
  };
  const handleSave = () => {
    setSaved(true);
  ...
  const missedCount = (analysis == null ? void 0 : analysis.filter((w) => w.status === "missed").length) ?? 0;
  const mispronounced = (analysis == null ? void 0 : analysis.filter((w) => w.status === "mispronounced").length) ?? 0;
  const correct = (analysis == null ? void 0 : analysis.filter((w) => w.status === "correct").length) ?? 0;
  const total = (analysis == null ? void 0 : analysis.length) ?? 0;
  const accuracy = total > 0 ? Math.round(correct / total * 100) : 0;
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-white", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-rose-500 text-white px-4 pt-10 pb-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl font-bold", children: "🎙️ Read & Record" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/70 text-sm mt-1", children: "Record yourself reading, then see your results" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 space-y-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-amber-50 rounded-2xl p-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 text-xs font-semibold uppercase tracking-wide mb-2", children: "Read this aloud:" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-800 text-lg leading-relaxed font-body", children: passage.recordPassage })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          onClick: recording ? stopRecording : startRecording,
          className: `w-32 h-32 rounded-full flex flex-col items-center justify-center text-white font-semibold shadow-lg transition-all ${recording ? "bg-rose-600 animate-pulse scale-110" : "bg-rose-500 hover:bg-rose-600 hover:scale-105"}`,
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-4xl", children: recording ? "⏹" : "🎙️" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm mt-1", children: recording ? "Stop" : "Record" })
          ]
        }
      ) }),
      recording && transcript && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-blue-50 border border-blue-200 rounded-xl p-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-blue-500 text-xs font-semibold uppercase mb-1", children: "Listening…" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-blue-800 text-sm italic", children: transcript })
      ] }),
      !speechSupported && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-yellow-50 border border-yellow-200 rounded-xl p-3 text-yellow-700 text-sm", children: "⚠️ Speech recognition is not supported in this browser. Recording will still work but word analysis won't be available. Try Chrome for full features." }),
      ...
      audioURL && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-green-50 border border-green-200 rounded-2xl p-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-green-800 font-semibold text-sm mb-2", children: "✓ Recording done! Play it back:" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "audio",
            {
        ...
        analysis && analysis.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white border border-gray-200 rounded-2xl p-4 space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold text-gray-800 text-base", children: "📊 Your Reading Analysis" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-3 gap-2 text-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-green-50 rounded-xl p-3", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-green-700 font-semibold", children: "Accuracy" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-orange-50 rounded-xl p-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-2xl font-bold text-orange-600", children: mispronounced }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-orange-700 font-semibold", children: "Mispronounced" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-rose-50 rounded-xl p-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-2xl font-bold text-rose-600", children: missedCount }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-rose-700 font-semibold", children: "Missed" })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 text-xs font-semibold uppercase mb-2", children: "Word-by-word breakdown:" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1.5", children: analysis.map((w, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "span",
              {
                title: w.status === "mispronounced" ? `You said: "${w.heard}"` : w.status === "missed" ? "Word not read" : "Correct",
                className: `px-2 py-1 rounded-lg text-sm font-medium border ${w.status === "correct" ? "bg-green-50 border-green-300 text-green-800" : w.status === "mispronounced" ? "bg-orange-100 border-orange-400 text-orange-800" : "bg-rose-100 border-rose-400 text-rose-800 line-through"}`,
                children: [
                  w.original,
                  w.status === "mispronounced" && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-1 text-orange-500 text-xs", children: "⚠" }),
                  w.status === "missed" && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-1 text-rose-500 text-xs", children: "✗" })
                ]
              },
              `${w.original}-${i}`
            )) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3 mt-3 text-xs", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-3 h-3 rounded bg-green-200 inline-block" }),
                "Correct"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-3 h-3 rounded bg-orange-200 inline-block" }),
                "Mispronounced"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-3 h-3 rounded bg-rose-200 inline-block" }),
                "Missed"
              ] })
            ] })
          ] })
        ] }),
        transcript === "" && speechSupported && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-yellow-50 border border-yellow-200 rounded-xl p-3 text-yellow-800 text-sm", children: "No speech detected. Make sure your microphone is working and try again." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white border border-gray-200 rounded-2xl p-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600 text-sm font-semibold mb-2", children: "How did it go?" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 gap-2", children: ratings.map((r2, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              type: "button",
              "data-ocid": `record.rating.${i + 1}`,
              onClick: () => setRating(i),
              className: `p-3 rounded-xl border-2 text-center transition-all ${rating === i ? `${r2.color} scale-105` : "border-gray-200 bg-white text-gray-600"}`,
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xl", children: r2.emoji }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-semibold mt-1", children: r2.label })
              ]
            },
            r2.label
          )) })
        ] }),
        rating !== null && !saved && /* @__PURE__ */ jsxRuntimeExports.jsx(
          Button,
          {
...
const passages = [
  // ── GRADE 1 – Passage A ──────────────────────────────────────────────────
  {
    ...
    recordPassage: "Sam has a red hat. He likes to wear it every day. One day the wind blew his hat away. Sam ran fast to get it back."
  },
  // ── GRADE 1 – Passage B ──────────────────────────────────────────────────
  {
    id: "g1b",
    ...
    recordPassage: "A little blue bird sat in a big tree. She had a soft nest made of twigs and grass. One morning she laid three small eggs. She sat on the eggs to keep them warm."
  },
  // ── GRADE 2 – Passage A ──────────────────────────────────────────────────
  {
    id: "g2",
    ...
    recordPassage: "Lily visited her grandpa's farm last summer. There were cows, chickens, and a big brown horse. The horse was her favourite because it had a long golden mane."
  },
  // ── GRADE 2 – Passage B ──────────────────────────────────────────────────
  {
    id: "g2b",
    ...
    recordPassage: "The students in Class Two planted a garden behind their school. They dug small holes and dropped seeds inside. After two weeks, tiny green shoots appeared."
  },
  // ── GRADE 3 – Passage A ──────────────────────────────────────────────────
  {
    id: "g3",
    ...
    recordPassage: "One rainy afternoon, Maya found a small brown puppy hiding under a park bench. It was shivering and looked very scared. Maya gently picked it up and wrapped it in her jacket."
  },
  // ── GRADE 3 – Passage B ──────────────────────────────────────────────────
  {
    id: "g3b",
    ...
    recordPassage: "Every summer, the Harrison family drove to the coast to visit an old lighthouse. Mia loved climbing the spiral staircase to reach the lamp room at the top. From there, she could see fishing boats dotting the horizon."
  },
  // ── GRADE 4 – Passage A ──────────────────────────────────────────────────
  {
    id: "g4",
    ...
    questions: [
      ...
      {
        question: "What did Kai's mother encourage him to do when his legs ached?",
        options: [
          "Rest and eat",
          "Turn back",
    ...
    recordPassage: "The Chen family had been planning their hiking trip for months. Kai could hardly contain his excitement. They drove three hours through winding roads until the snow-capped peaks came into view."
  },
  // ── GRADE 4 – Passage B ──────────────────────────────────────────────────
  {
    id: "g4b",
    ...
    recordPassage: "Twelve-year-old Aisha had been working on her science fair project for six weeks. She was building a small car powered entirely by solar energy. On the day of the fair, thick clouds covered the sky, but when sunlight appeared the little car zipped across the floor."
  },
  // ── GRADE 5 – Passage A ──────────────────────────────────────────────────
  {
    id: "g5",
    ...
    recordPassage: 'The old grandfather clock in the hallway had not ticked for twenty years. One stormy evening, Zara discovered a small brass key with a label that read "For the clock, when the right time comes."'
  },
  // ── GRADE 5 – Passage B ──────────────────────────────────────────────────
  {
    id: "g5b",
    ...
    recordPassage: "When the Nakamura family began renovating their old Victorian house, they found a small tin box sealed behind the bathroom wall. Inside was a letter from 1923, written by a girl named Clara, who described her dreams and her life."
  }
];
const getPassageByGrade = (grade, index2 = 0) => {
  const gradePassages = passages.filter((p) => p.grade === grade);
  if (gradePassages.length === 0) return passages[0];
  return gradePassages[index2 % gradePassages.length];
};
...
function useStudentStore() {
  const [student, setStudentState] = reactExports.useState(() => {
    try {
...
function App() {
  ...
  const currentOffset = ((_a2 = student.passageOffsets) == null ? void 0 : _a2[student.grade]) ?? 0;
  const passage = getPassageByGrade(student.grade, currentOffset);
  const handleOnboarding = (name, grade) => {
  ...
  const handleMissingComplete = (score) => {
    addSession({
      passageId: passage.id,
      grade: student.grade,
      score,
  ...
  if (screen === "onboarding") {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Onboarding, { onComplete: handleOnboarding });
  }
  if (screen === "passage") {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      PassageReader,
...
Service({
  "getChatHistory": Func([Text], [Vec(ChatMessage)], ["query"]),
  "registerPhone": Func([Text], [Bool], []),
  "sendMessage": Func([Text, Text], [Text], []),
  "setTopic": Func([Text, Text], [], [])
});
